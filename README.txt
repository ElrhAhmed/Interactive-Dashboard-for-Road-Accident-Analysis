## Analyzing Road Traffic Accidents in Morocco
...
To ensure a clear and correct view of the project, adjust the following screen settings:
...
Hover over the visualizations to display the legend (key).
